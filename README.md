...
<p align="justify">
Below are sample results showing how the assistant responds to both SQL and document-based queries. The assistant intelligently routes the question through the appropriate retrieval engine and generates contextually relevant answers using OpenAI.
</p>

<h4>🔎 Document-Based Retrieval Example</h4>
<img src="images/document_file.png" alt="Document QA Result" width="600"/>

<h4>🧮 SQL-Based Insight Example</h4>
<img src="images/database_file.png" alt="SQL QA Result" width="600"/>
